...
- **Dobbelttrykk på 3D-bildet** fyller hele skjermen, og et nytt dobbelttrykk går tilbake. Ett trykk, dra og knappene virker som før. Hvis nettleseren ikke har full skjerm, sier spillet fra at siden kan legges til på Hjem-skjermen i stedet.
